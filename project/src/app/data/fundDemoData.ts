...
export const initialEvidenceRecords: EvidenceRecord[] = [
  ...
  {
    evidenceRefId: "ev-cash-sub-003",
    fundId: "fund-open-001",
    classId: "DLF-HKD",
    instructionId: "instr-sub-003",
    registerDeltaId: "delta-sub-003",
    evidenceType: "CashConfirmation",
    label: "Tokenized deposit receipt TX-OPEN-HKD-003",
    contentHash: "0xevcashsub003",
    sourceActorType: "Custodian",
    sourceActorId: "stablecoin-custodian-hkd",
    createdAt: "2026-04-16 14:06:00",
    retentionClass: "Audit",
    version: 1,
  },
  {
  ...
  {
    evidenceRefId: "ev-nav-rea-20260512",
    fundId: "fund-closed-001",
    classId: "REA-HKD",
    instructionId: "instr-red-ce-001",
    registerDeltaId: "delta-red-ce-001",
    evidenceType: "NAVPublication",
    label: "Official NAV 100 HKD for repurchase event",
    contentHash: "0xevnavrea20260512",
    sourceActorType: "System",
    sourceActorId: "nav-service",
  ...
  {
    evidenceRefId: "ev-issuer-redemption-approval",
    fundId: "fund-closed-001",
    classId: "REA-HKD",
    instructionId: "instr-red-ce-001",
    registerDeltaId: "delta-red-ce-001",
    evidenceType: "ProductProviderApproval",
    label: "Issuer approval for Real Estate Fund A repurchase event",
    contentHash: "0xevissuerredemptionapproval",
    sourceActorType: "Issuer",
    sourceActorId: "issuer-real-estate-a",
    createdAt: "2026-05-12 16:18:00",
    retentionClass: "Regulatory",
    version: 1,
  },
  {
  ...
  {
    evidenceRefId: "ev-issuer-dist-approval",
    fundId: "fund-closed-001",
    classId: "REA-HKD",
    instructionId: "instr-dist-002",
    registerDeltaId: "delta-dist-002",
    evidenceType: "ProductProviderApproval",
    label: "Issuer approval for 2026 interim distribution",
    contentHash: "0xevissuerdistapproval",
    sourceActorType: "Issuer",
    sourceActorId: "issuer-real-estate-a",
    createdAt: "2026-05-20 17:28:00",
    retentionClass: "Regulatory",
    version: 1,
  },
  {
